...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  const renderIllustration = () => {
    switch (icon) {
      case "bet":
        return (
          <svg className="w-24 h-24 th-acc/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <circle cx={16} cy={16} r={1.5} fill="currentColor" className="th-acc/50" />
          </svg>
        );
      case "ticket":
        return (
      ...
      case "transfer":
        return (
          <svg className="w-24 h-24 text-cyan-500/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <circle cx={12} cy={7.5} r={2} className="th-info/50" fill="currentColor" />
            <circle cx={12} cy={16.5} r={2} className="th-info/50" fill="currentColor" />
          </svg>
        );
      default:
        return (
